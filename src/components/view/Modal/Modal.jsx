...
export default function Modal({ isOpen, onClose }) {
  ...
  return (
    <div
      role="dialog"
      aria-modal="true"
      className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-2 sm:px-4 overflow-y-auto h-full"
      onKeyDown={(e) => e.key === "Escape" && handleClose()}
    >
      <div className="bg-white rounded-xl shadow-xl relative w-full max-w-md sm:max-w-lg lg:max-w-2xl p-4 sm:p-6 lg:p-8 min-h-[70vh]">
        <button
